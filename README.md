...
# MSAL C# + Powershel Public Client - **Sample**

<img src="./images/7.svg" width="150" height="150" />  &  <img src="./images/powershell.png" width="450" height="145" />  
...
```bash
git clone https://github.com/MTCMarkFranco/msalClient.git
```
...
[Powershell]
Execute with Administrator priveledges
```
...
- [Application configuration options](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/active-directory/develop/msal-client-application-configuration.md#application-configuration-options)
...
# MSAL General Documentation & Links
